...
class UG_Main {
    ...
    public function enqueue_admin_assets($hook) {
        ...
        wp_localize_script('ug-admin-script', 'ug_ajax', array(
    ...
    public function hide_other_plugin_notices() {
        ...
        if ($screen->base !== 'toplevel_page_upload-to-github') {
            return;
        }
        ?>
        <style>
    ...
    private function render_settings_tab() {
        ...
        $is_private = ($settings['repo_visibility'] === 'private');
        ...
        <form id="ug-settings-form" novalidate>
            ...
            <div class="ug-form-group">
                ...
                <input type="text" 
                       ...
                       data-validate="repo"
                       data-required="true"
                       <?php echo $is_private ? 'disabled="disabled"' : ''; ?>>
        ...
        <?php else: ?>
            <div class="ug-stats-grid">
                <div class="ug-stat-card">
                    <div class="ug-stat-number"><?php echo number_format($total_count); ?></div>
                ...
                <div class="ug-stat-card">
                    <div class="ug-stat-number" id="ug-remaining-count"><?php echo number_format($total_count); ?></div>
